		...
		<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog modal-sm" role="document">
		    <div class="modal-content">
		      ...
		      <form action="{{ url('bendahara/create') }}" method="POST" data-remote="data-remote">
		        ...
		        <div class="modal-footer">
		          ...
		          <a href="{{ url('') }}" class="btn btn-info">Reload</a>
					...
					<div class="modal fade" id="edit{{ x.id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					  <div class="modal-dialog modal-sm" role="document">
					    <div class="modal-content">
					      ...
					      <form action="{{ url('bendahara/update') }}" method="POST" data-remote="data-remote">
					        <div class="modal-body">
					          <div class="form-group">
					  ...
					  <div class="modal-dialog modal-sm" role="document">
					    <div class="modal-content">
				          ...
				          <div class="modal-footer">
				          	...
				          	<form action="{{ url('bendahara/delete/') }}" method="GET" data-remote="data-remote">
				          	  <input type="hidden" name="id" value="{{ x.id }}">
